...
set DAYSWITHOUTMULTIPLESTAY default {1..DAY_count-STAY*(M-1)};
set LASTDAYS default {DAY_count-STAY*(M-1)+1..DAY_count};
...
s.t. c1 : sum{v in V,e in E, day in DAYS} A[e,v,day]*x[e,day] == M;
s.t. c2 {v in V} : sum{ day in DAYS,e in E} (A[e,v,day]*x[e,day] - B[e,v,day]*x[e,day]) == 0;
s.t. c3 {day in DAYSWITHOUTSTAY,v in V : v <> S} : sum{e in E} (A[e,v,day+STAY]*x[e,day+STAY] - B[e,v,day]*x[e,day]) == 0;
s.t. c4 {day in DAYSWITHOUTMULTIPLESTAY,v in V : v == S} : sum{e in E} (A[e,v,day]*x[e,day] - B[e,v,day+STAY*(M-1)]*x[e,day+STAY*(M-1)]) == 0;
s.t. c5 {e in E, day in LASTDAYS} : x[e,day] == 0;
